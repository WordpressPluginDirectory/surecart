...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (index.h(index.Host, { key: 'a5a935eb44d3e61cdd964a0fafcb4b348d1db736' }, index.h("sc-form-control", { key: '084d082134d21f1633f486d23eb725cd1882e8b2', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: 'b81aa656b62415b93edab3428195da5029176c58', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, index.h("div", { key: '09d18f1b56948df81f2a9530b0fe555bb3e38ebd', class: "menu" }, index.h("sc-button", { key: '7e15f8035a56b6b05c6274b66191d3afd067228e', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, index.h("sc-icon", { key: 'b0b551d25240c2feb80324361c1a66c432517a24', name: "bold" })), index.h("sc-button", { key: '604ca60faa97739ee87e589c3725cc9fa67b40eb', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, index.h("sc-icon", { key: 'a27afcf2842b257c497556a3580d7b9890b1245f', name: "italic" })), index.h("sc-button", { key: 'c029a524863913845e584db0e96e74b48f9a208f', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, index.h("sc-icon", { key: '18ab6cd733c1f74660c6678f575bb3facba915f4', name: "list" })), index.h("sc-button", { key: '80ceb3aec166e36ecb9dba3b336a10528856d447', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, index.h("sc-icon", { key: '41ecbd32b34ccecaa2f1dbbb4a1ac85af18b090d', name: "minus" })), index.h("sc-button", { key: '94ba63f9be11b643f3403f33ab30a07217a6dd03', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, index.h("sc-icon", { key: 'ac4e9b4f9ef36f5453247590c2d873272bc35925', name: "corner-up-left" })), index.h("sc-button", { key: 'fa829fe73ef89a9783efc464b84a3edfd041ab1b', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, index.h("sc-icon", { key: 'eed8a15f97c497250c3009670688fdbdc1dc8763', name: "corner-up-right" }))), index.h("div", { key: '4975852cdb5575710553becd81872e3381ff5731', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && index.h("div", { key: 'b56a6b5860f39158d98d1209c7d48c3d5350a8f4', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
