...
const ScButton = class {
    ...
    render() {
        ...
        const interior = (index.h(index.Fragment, { key: 'e2d1f2390d095c741ee00b4e04f9bc485ff045f7' }, index.h("span", { key: 'b99e17cae26a127a34877fbec2f8f789d72d2917', part: "prefix", class: "button__prefix" }, index.h("slot", { key: '42f563cf0b37b5e1d8a41ff60ce4aad5db6d7167', onSlotchange: () => this.handleSlotChange(), name: "prefix" })), index.h("span", { key: '9f8ad139af7a03f6238cdc8edd735b276be6f9c5', part: "label", class: "button__label" }, index.h("slot", { key: '91be30c4da5e7a77c25291943a0c038a31a94110', onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: '79097fcb3e07b8b025846cf2e6061979be104d78', part: "suffix", class: "button__suffix" }, index.h("slot", { key: 'b9d483b2b399c78e68070c5bc173179626c89cc4', onSlotchange: () => this.handleSlotChange(), name: "suffix" })), this.caret ? (index.h("span", { part: "caret", class: "button__caret" }, index.h("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }, index.h("polyline", { points: "6 9 12 15 18 9" })))) : (''), this.loading || this.busy ? index.h("sc-spinner", { exportparts: "base:spinner" }) : ''));
        return (index.h(Tag, { key: '431992a545464c94bb8b5d429595c57b27360139', part: "base", class: {
                'button': true,
