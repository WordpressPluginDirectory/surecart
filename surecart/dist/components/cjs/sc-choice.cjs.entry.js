...
const ScChoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '38beb3e55fa4f2cefd354d6776a52625fb5848f5', tabindex: "0", onFocus: () => this.input.focus() }, index.h("div", { key: 'e223391f367b53a290ee3cb9cef5c65335294ac4', part: "base", class: {
                'choice': true,
            ...
            }, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("slot", { key: 'c6b9461419228676680d23168d6feb02b585c0bc', name: "header" }), index.h("label", { key: '687d102727340e40d6fad10f4c7821fe59fbc945', class: "choice__content", part: "content", htmlFor: this.inputId }, index.h("span", { key: 'f3414fde724eee20c01e37abf346ea355daee68b', part: "control", class: {
                choice__control: true,
                choice__checkbox: this.type === 'checkbox',
                choice__radio: this.type === 'radio',
            }, hidden: !this.showControl }, index.h("span", { key: '99247b048512becf5651dbcfd58adf9e9245845c', part: "checked-icon", class: "choice__icon" }, this.type === 'checkbox' ? (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(3.428571, 3.428571)" }, index.h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), index.h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" })))))) : (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { fill: "currentColor" }, index.h("circle", { cx: "8", cy: "8", r: "3.42857143" })))))), index.h("input", { key: 'e40ff2c0d19f50eb8acc6c138c3b28eef5f3ba36', id: this.inputId, ref: el => (this.input = el), type: this.type, name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, tabindex: "0",
            // required={this.required}
            onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), index.h("span", { key: 'd95ec0842beb7931958de923661717ac29917b2c', part: "label", id: this.labelId, class: "choice__label" }, index.h("span", { key: 'ba080782a9103f9c4851adaa4f90150fe1e57a5a', class: "choice__label-text", hidden: !this.showLabel }, index.h("span", { key: '6efe9c39216cb6fb3b38232ea5b26ca7c5e3b5a3', class: "choice__title", part: "title" }, index.h("slot", { key: '69403c82f7e4d496620d2f97611d175dec5f36fa', onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: 'f570721d0f303c1ea45a98604e3ee00e52844103', class: "choice__description description", part: "description", hidden: !this.hasDescription }, index.h("slot", { key: 'a9ea135baab5a47985c500f1fc2d524aa7bb89e3', name: "description", onSlotchange: () => this.handleSlotChange() }))), index.h("span", { key: 'a499130937851bfb21d1c06eaa1a2bff427b8571', class: "choice__price", hidden: !this.showPrice || (!this.hasPrice && !this.hasPer) }, index.h("span", { key: '01fefceaccfc98885c9dde7ec5ecd77e308d59a5', class: "choice__title" }, index.h("slot", { key: 'a401e7414274244e622a5a8b750cd643b74d7169', name: "price", onSlotchange: () => this.handleSlotChange() })), ' ', index.h("span", { key: 'df15bcd01847278d661b7c517ca990fc3b585244', class: "choice__description" }, index.h("slot", { key: '6d1469606530611190f8d5610e7be41cb6a8acee', name: "per", onSlotchange: () => this.handleSlotChange() }))))), index.h("slot", { key: '7536cca002e8b3d9903608edb803d9f936502538', name: "footer" }))));
    }
