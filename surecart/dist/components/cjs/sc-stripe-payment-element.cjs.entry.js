...
const ScStripePaymentElement = class {
    ...
    render() {
        return (index.h("div", { key: '5a429f0e46f4a650d4fceea406e0542b8356c843', class: "sc-stripe-payment-element", "data-testid": "stripe-payment-element" }, !!this.error && (index.h("sc-text", { key: '351fb4054788e4213d7743bf067e6213d706a1df', style: {
                'color': 'var(--sc-color-danger-500)',
                '--font-size': 'var(--sc-font-size-small)',
                'marginBottom': '0.5em',
            } }, this.error)), index.h("div", { key: '5b2e9abf48180e24b6aaec7d35e1440d7a47340c', class: "loader", hidden: this.loaded }, index.h("div", { key: 'e09d777c4fc3c110451012a35d474f8b0da9247b', class: "loader__row" }, index.h("div", { key: '0e71dc3b995c86ca0f7fa794ac3a9af47dee7742', style: { width: '50%' } }, index.h("sc-skeleton", { key: 'f7b5f6ff304183bc6dd8a893b042653051bf902f', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '883ce3a8c3353a16587def7870d56a6e17fcb296' })), index.h("div", { key: '79443b0f986dc917affca3de555a42e7e197b5a6', style: { flex: '1' } }, index.h("sc-skeleton", { key: '1c49cc719b3b91968dbbeb847365914eb5607b41', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '9260defe9f3416393307cb48b15853dd519d1419' })), index.h("div", { key: '8cb9c68432d22304997be5afa726b36d8495fad5', style: { flex: '1' } }, index.h("sc-skeleton", { key: '6a37f1eb19ea8b7b3e59cefb7044c48478426db9', style: { width: '50%', marginBottom: '0.5em' } }), index.h("sc-skeleton", { key: '458635df9fe13abd81ccdd450bfaf0ebccbc3979' }))), index.h("div", { key: '4a3690c02ece290a7881c75c180a392b5d2a79ec', class: "loader__details" }, index.h("sc-skeleton", { key: '3c5fb8fc8ec4685b74b67f9572525d64b2060304', style: { height: '1rem' } }), index.h("sc-skeleton", { key: '1f36b893c77db4abc13162a595ad006515396063', style: { height: '1rem', width: '30%' } }))), index.h("div", { key: '20ec2c083678bf42b7eff981d0207aa34325c98c', hidden: !this.loaded, class: "sc-payment-element-container", ref: el => (this.container = el) })));
    }
