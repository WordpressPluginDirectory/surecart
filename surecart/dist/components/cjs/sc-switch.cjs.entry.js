...
const ScSwitch = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '44ab63ab9652bb5c01b5c8efdf45f5fba86f0721', part: "base", htmlFor: this.switchId, class: {
                'switch': true,
            ...
            }, onMouseDown: e => this.handleMouseDown(e) }, index.h("span", { key: 'fce02dd588e70cf5234c8cca9b979cc06041e30f', part: "control", class: "switch__control" }, index.h("span", { key: '83e0bca5c26872401f93e7e5fc162d8f9aa32b79', part: "thumb", class: "switch__thumb" }), index.h("input", { key: 'a5ee0b3bf84c49e0b8686a8ea7e0757e68d26d5d', ref: el => (this.input = el), id: this.switchId, type: "checkbox", role: "switch", name: this.name, value: this.value || 'on', checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onKeyDown: e => this.handleKeyDown(e) })), index.h("span", { key: '2958b5b6abf95dbdffbe8f2c24fab636bccac569', class: "switch__label", part: "label" }, index.h("span", { key: 'e73fd6021085e631c8e4f7f03fcc7775da0ddf1d', part: "title", id: this.labelId, class: "switch__title" }, index.h("slot", { key: 'f11fff80bf770b6ad894021f755f8dc5b0b5e2e8' })), index.h("span", { key: 'c787f30d73ea6f23f147d0177842752e5280e8c3', class: "switch__description", part: "description" }, index.h("slot", { key: 'a3633373ea9c96bdb0829541db198f257763b323', name: "description" })))));
    }
