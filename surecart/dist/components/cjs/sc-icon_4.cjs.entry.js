...
const ScIcon = class {
    ...
    render() {
        return index.h("div", { key: '8d58ee015670b8a4b10c5276fa549c8041b09ed6', part: "base", class: "icon", role: "img", "aria-label": this.getLabel(), innerHTML: this.svg });
    }
...
const ScProductLineItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e7fad7172ae6939d6d838192348ca7f4be62a3a2', class: "base", part: "base" }, index.h("div", { key: 'e81a439ab2621f48e909da2dcaf89500d5e7c11a', part: "product-line-item", class: {
                'item': true,
            ...
            } }, !!((_c = this.image) === null || _c === void 0 ? void 0 : _c.src) ? (index.h("img", { ...this.image, part: isImageFallback ? 'placeholder__image' : 'image', class: isImageFallback ? 'item__image-placeholder' : 'item__image' })) : (index.h("div", { class: "item__image-placeholder", part: "placeholder__image" })), index.h("div", { key: 'e11970083becc0e32eae7229bc44830587cea8b1', class: "item__text-container" }, index.h("div", { key: 'ca5ca06350b800b7a6ac4ed6983721bddb637378', class: "item__row" }, index.h("div", { key: '6921476f1cefa0fa64407fca1914d6cc9838a8f2', class: "item__title", part: "title" }, index.h("slot", { key: '08e0161f57b808cde336ff1a89ee73550e738b3f', name: "title" }, this.name)), index.h("div", { key: '01cc5f78445997f45f7ccf40babe08a363b6ce7d', class: "price", part: "price__amount" }, !!this.scratch && this.scratch !== this.amount && index.h("span", { key: 'd745d237d0492fae5ba29338de1e2568d252eaba', class: "item__scratch-price" }, this.scratch), this.amount, index.h("div", { key: '4f0d2aa24e5ba5e0bff2e538cdb9feee753a3c3c', class: "price__description", part: "price__description" }, this.interval))), index.h("div", { key: 'cbea894878d128fdac135e5121fa88ff9db3d697', class: "item__row" }, index.h("div", { key: 'd384f900beeaa4d931e4643abe3fac5cf212bbc3', class: "item__description", part: "description" }, this.variant && index.h("div", { key: '6ed59bd0e4d91383b6e541882d7e741e46d80c39' }, this.variant), this.price && index.h("div", { key: 'ee796988e2d044c265c53d5f35cee941b1af8037' }, this.price), this.sku && (index.h("div", { key: 'e33ed6919de0a2e6551019b6b6e36c6aeb496862' }, wp.i18n.__('SKU:', 'surecart'), " ", this.sku)), !!this.purchasableStatus && index.h("div", { key: '8ac78da7f269505aa1a48bb0aa33a235f3e0245c' }, this.purchasableStatus), !!this.note && index.h("sc-product-line-item-note", { key: '2258022966a56fd0faec45e945c0699b8b395c10', note: this.note })), index.h("div", { key: '24cc7f0eb6936d6be70abb96216cab60c8c4dac9', class: "item__description", part: "trial-fees" }, !!this.trial && index.h("div", { key: 'd85cc8040ac061f06e779fb3ae67f56c6259a84c' }, this.trial), (this.fees || []).map(fee => {
            return (index.h("div", null, fee === null || fee === void 0 ? void 0 :
                fee.display_amount, " ", fee === null || fee === void 0 ? void 0 :
                fee.description));
        }))), index.h("div", { key: '732b4ba51909a815ee675948602845cc6d5dc492', class: "item__row stick-bottom" }, this.editable ? (index.h("sc-quantity-select", { max: this.max || Infinity, exportparts: "base:quantity, minus:quantity__minus, minus-icon:quantity__minus-icon, plus:quantity__plus, plus-icon:quantity__plus-icon, input:quantity__input", clickEl: this.el, quantity: this.quantity, size: "small", onScChange: e => e.detail && this.scUpdateQuantity.emit(e.detail), "aria-label": 
            /** translators: %1$s: product name, %2$s: product price name */
            wp.i18n.sprintf(wp.i18n.__('Change Quantity - %1$s %2$s', 'surecart'), this.name, this.price) })) : (index.h("span", { class: "item__description", part: "static-quantity" }, wp.i18n.__('Qty:', 'surecart'), " ", this.quantity)), !!this.removable && (index.h("div", { key: '69292ae1995504050d298870ac77e6a27b361fb8', class: "item__remove-container", onClick: () => this.scRemove.emit(), onKeyDown: e => {
                if (e.key === 'Enter') {
                    this.scRemove.emit();
                }
            }, "aria-label": wp.i18n.sprintf(wp.i18n.__('Remove Item - %1$s %2$s', 'surecart'), this.name, this.price), tabIndex: 0 }, index.h("sc-icon", { key: 'adc81c572765901a8520597e7769d17c864df4de', exportparts: "base:remove-icon__base", class: "item__remove", name: "x" }), index.h("span", { key: 'd1a30ad9cf8ae52d04f9ac082266b28148d80e1e', class: "item__remove-text" }, wp.i18n.__('Remove', 'surecart')))))))));
    }
...
const ScQuantitySelect = class {
    ...
    render() {
        return (index.h("div", { key: '6878fc2fb4741ea8759da8e46fcab6b316c90406', part: "base", class: {
                'quantity': true,
                // States
            ...
            } }, index.h("button", { key: '39b1235dde4388afba005768903afc059c6bd673', part: "minus", "aria-label": wp.i18n.__('Decrease quantity by one.', 'surecart'), "aria-disabled": this.disabled || (this.quantity <= this.min && this.min > 1), class: { 'button__decrease': true, 'button--disabled': this.quantity <= this.min && this.min > 1 }, onClick: () => this.quantity > this.min && this.decrease(), disabled: this.disabled || (this.quantity <= this.min && this.min > 1) }, index.h("sc-icon", { key: '3bf1f13e9d250472ef230aaab6cc2046e0c1c79e', name: "minus", exportparts: "base:minus__icon" })), index.h("input", { key: '6a2d33a083f9a41926801e4c836b780ab5ddbf7a', part: "input", class: "input__control", ref: el => (this.input = el), step: "1", type: "number", max: this.max, min: this.min, value: this.quantity, disabled: this.disabled, autocomplete: "off", role: "spinbutton", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.quantity, "aria-disabled": this.disabled, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }), index.h("button", { key: '48a97bbc23197a912e47b2571035484ea170dd24', part: "plus", "aria-label": wp.i18n.__('Increase quantity by one.', 'surecart'), class: { 'button__increase': true, 'button--disabled': this.quantity >= this.max }, onClick: () => this.quantity < this.max && this.increase(), "aria-disabled": this.disabled || this.quantity >= this.max, disabled: this.disabled || this.quantity >= this.max }, index.h("sc-icon", { key: '4877a9f3474fc72582347c3bd6ca40e841455e5e', name: "plus", exportparts: "base:plus__icon" }))));
    }
    get el() { return index.getElement(this); }
};
