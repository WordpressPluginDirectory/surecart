...
const ScPaystackAddMethod = class {
    ...
    render() {
        return (index.h(index.Host, { key: '00b826b1a6736327717449c8000f41c157cb3aaa' }, this.error && (index.h("sc-alert", { key: '2ce0ffb5a2c28bfcb889e997a46a8c6f5f7c5dd6', open: !!this.error, type: "danger" }, index.h("span", { key: '73a17d1e8a0f079b5722b60de6aa812df123bf02', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), index.h("div", { key: '0963f38d1fabc4845a26fccb7adf59e9d365f3ec', class: "sc-paystack-button-container" }, index.h("sc-alert", { key: '5e0093917adc829b12f8b43d053604ca66a6d72a', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), index.h("div", { key: 'b9eed5f4d1a9c4f46e81ebb1213e72d1c7b4ecf5' }, index.h("sc-button", { key: 'd847bcd6adf494f2768704a63403808f036f78e7', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
