...
const ScHeading = class {
    ...
    render() {
        return (index.h("div", { key: 'f62cfc9d90b6976215cc6010c3bb77f06a7d30b9', part: "base", class: {
                'heading': true,
                'heading--small': this.size === 'small',
                'heading--medium': this.size === 'medium',
                'heading--large': this.size === 'large',
            } }, index.h("div", { key: '7d4e8b1a3be32903aeb7e807546de965a94e9f96', class: { heading__text: true } }, index.h("div", { key: '3af7bc5a59ff93dcd8aebaa4c6e8158c68b9e030', class: "heading__title", part: "title" }, index.h("slot", { key: '16727b87737f0d9698a645c22e4533f64132db45' })), index.h("div", { key: 'd4ae6eb23a4500058e79b11913a0ea46ef6d1aa9', class: "heading__description", part: "description" }, index.h("slot", { key: 'e54b051cd369c8a93fdfb21b82dac378182d832b', name: "description" }))), index.h("slot", { key: '4804e563135589bd01d4b7e1fc146c2e909e5fda', name: "end" })));
    }
...
const ScOrderConfirmComponentsValidator = class {
    ...
    render() {
        return index.h("slot", { key: '3256d44c36a96a5d0025a08ac6115ff4f62864ef' });
    }
    get el() { return index.getElement(this); }
