...
const ScCancelDiscount = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '120482a397bce6fde3cdadba608fe6c3855c466f', class: "cancel-discount" }, index.h("sc-dashboard-module", { key: '346bfdbab0996bd52dcfd7ea093b19512617a70a', heading: title, style: { '--sc-dashboard-module-spacing': '2em' } }, index.h("span", { key: 'f1a4e1bb0b997f75bcc58c378454dbb5d76d8561', slot: "description" }, description), index.h("sc-flex", { key: 'c3d86ecfa08d70809ff0310e64369f499f67f4da', justifyContent: "flex-start" }, index.h("sc-button", { key: 'befb32eb8c647e387f6ad0f7548a26c15b84ff88', type: "primary", onClick: () => this.addDiscount() }, button), index.h("sc-button", { key: '8bf48199193ea2b65d1789e7a57d27f300db6a6a', class: "cancel-discount__abort-link", type: "text", onClick: () => this.scCancel.emit() }, cancel_link)), !!this.loading && index.h("sc-block-ui", { key: '97f97b49cf9dd471157abe78dc627cf9c73690a6', spinner: true }))));
    }
};
...
const ScSubscriptionCancel = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: 'f0230ba9e84806ac1190af7bafaa1389ded64fd0', heading: this.heading || wp.i18n.__('Cancel your plan', 'surecart'), class: "subscription-cancel", error: this.error, style: { '--sc-dashboard-module-spacing': '1em' } }, this.renderContent(), index.h("sc-flex", { key: 'b1d7bfe567ca847dddc0eecf2b927ddff454b421', justifyContent: "flex-start" }, index.h("sc-button", { key: '1a91e86325a3581687a01d8b69a52a09d4f12f28', type: "primary", loading: this.loading || this.busy, disabled: this.loading || this.busy, onClick: () => this.cancelSubscription() }, wp.i18n.__('Cancel Plan', 'surecart')), index.h("sc-button", { key: '63eccba98b8f026efbdda561763c7c4f02b8154b', style: { color: 'var(--sc-color-gray-500' }, type: "text", onClick: () => this.scAbandon.emit(), loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Keep My Plan', 'surecart'))), this.busy && index.h("sc-block-ui", { key: '2763d7ebb12a5515b24e3497730e27d21bf6ec9d' })));
    }
};
...
const ScTextarea = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'b94cb75a2c4c6b1c6aae653e55ef17c3a4f9eabf', part: "form-control", class: {
                'form-control': true,
                'form-control--small': this.size === 'small',
                'form-control--medium': this.size === 'medium',
                'form-control--large': this.size === 'large',
            } }, index.h("sc-form-control", { key: '4d824ed69e6c3e8c15677102bffd2a0b2efa7137', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: '577ab4b479af00b1bea53a71207c9f43979bdab0', part: "form-control-input", class: "form-control-input" }, index.h("div", { key: 'ac2725150c4551c29a0062ab95e34a406458e185', part: "base", class: {
                'textarea': true,
            ...
            } }, index.h("textarea", { key: 'c459f3c4a97b446206e6dcb2417a778f58764e71', part: "textarea", ref: el => (this.input = el), id: "input", class: "textarea__control", name: this.name, value: this.value, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, rows: this.rows, minlength: this.minlength, maxlength: this.maxlength, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, enterkeyhint: this.enterkeyhint, inputmode: this.inputmode, "aria-describedby": "help-text", onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), onKeyDown: (e) => e.stopPropagation() })), this.showCharLimit && (index.h("div", { key: '94f0922f5d9ac65c7961f9badff88ee239253485', slot: "help", class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.maxlength && ((_a = this.input) === null || _a === void 0 ? void 0 : _a.value) ? this.maxlength - this.input.value.length : this.maxlength)))))));
    }
