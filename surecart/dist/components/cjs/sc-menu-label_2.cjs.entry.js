...
const ScMenuLabel = class {
    ...
    render() {
        return (index.h("div", { key: '1b972ae87780fbf0144451456046932169912b0b', part: "base", class: "menu-label" }, index.h("slot", { key: 'a28c1e64eb6008d5c19a2701d358314806e35d74' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'b921e2ef797ce9a28008b4ddf8eb0c7b442dc4b0', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: 'f110289a97e42cabc6abe45609d208624b1a736f', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '87a809056020d69de9d95e673e953d475bc0c243', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, autocomplete: this.autocomplete, tabindex: "-1", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleInputChange() }), index.h("sc-dropdown", { key: '6d8bd8bd0cb237c7d5165c064093d7d1f650ae36', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, index.h("slot", { key: 'cfdd9c520438f8068a7743b062eab1a6f049d614', name: "trigger", slot: "trigger" }, index.h("div", { key: '97326959d95711cdc61ebdc8bac9c80d91bd9abd', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: 'd088add68eff8cfcc8075b784d6601c8fc380e19', class: "select__value" }, index.h("slot", { key: '480731b648458a740c861f0a4b329274451f12fe' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), index.h("sc-icon", { key: 'b1e0db7c0f9ace96a0ed92ea5fbb77a7989c25f8', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: 'c33c5ada2a24bd0b08f62ac2f747982fc4af840b', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: 'd8a0318a41284cb828b2b74c45128529c6edf89b', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: '277b908997e3d1df19c30056903ff4e19f356c74', style: { maxHeight: this.open ? '210px' : '0px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: 'b9dd96265b0016ec8163002a14fd1760dd907043', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: '87608dbe54ffc50318b7db3206e4c107e586c58f', class: "loading" }, index.h("sc-spinner", { key: '51f328b75df7a88b64cfe728d362fe9123bbc2f1', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: 'aa37a4f7a0696cc27109b40314486ac8282e8abf', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: 'cbe8c2b187526c5a0febb803e4be041a5b11a31f', name: "suffix" }))))));
    }
