...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '232ff892d6d416420a021143968be1a02f5fea74', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: '878eb18d0f82c4328a240829f86ebc1d98353a0b', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: 'e2586f125a9fbe47531a9716859cd3c94c353e06', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, autocomplete: this.autocomplete, tabindex: "-1", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleInputChange() }), index.h("sc-dropdown", { key: 'dc589068b57799b193bc6e564b41343471d950d2', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, index.h("slot", { key: '2bb7197be0fd1950a625913c7d2f9435cc0839e0', name: "trigger", slot: "trigger" }, index.h("div", { key: 'ce5fd771e3557e7dce53da7fc280b7442930a1e5', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: 'fd83d67c071824a7f7dad5fea342ac9628ec4fba', class: "select__value" }, index.h("slot", { key: '58764c40e1fa6e34d3eeb36d3bf46a0fe3d82da1' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), index.h("sc-icon", { key: 'f0129b9b2615155b6d2d92691737c1159181b911', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: 'e9591c4f5b05c8eab290d6dd60d9c52be00fc601', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart') }, this.loading && index.h("sc-spinner", { key: '6d85c05eba8659d1ddb90347733d16b8770b6183', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: '6a85cab13b03685304c0c06263de0d4a55e9dd32', style: { maxHeight: this.open ? '210px' : '0px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: '5c5ae15f9d12065a69cad50318786a53f2150818', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: 'e33cfa0f2a76f34b64416c61234374042125f622', class: "loading" }, index.h("sc-spinner", { key: 'c5d5cebcbbc7fc8fb5dbfd554a73be43bb3d53a9', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: '65d96bd195f781c147befc339bcf0afe68f9aa9b', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: '65429dbc30fedeb7d9d779f62dac5b74275d9090', name: "suffix" }))))));
    }
