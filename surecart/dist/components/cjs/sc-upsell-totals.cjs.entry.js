...
const ScUpsellTotals = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g;
        return (index.h("sc-summary", { key: '4f689b2cc6be5b1124ea1aa3d99cd8a2d57f3fc0', "open-text": "Total", "closed-text": "Total", collapsible: true, collapsed: true }, !!((_a = store.state.line_item) === null || _a === void 0 ? void 0 : _a.id) && index.h("span", { key: '758535e9d6b16f11dedf0aafe199ff6bd93ac44d', slot: "price" }, this.renderAmountDue()), index.h("sc-divider", { key: '31de0c592c1ec5ce00ad60cf7eb4353893ce0fb0' }), index.h("sc-line-item", { key: '83b70c804e36fe23433cda639488e040273ffafe' }, index.h("span", { key: '747e7836dff8c51d956f811da8c5f055845edb61', slot: "description" }, wp.i18n.__('Subtotal', 'surecart')), index.h("span", { key: '7bf051a78d3a8a493ce4fbaef886be00e7388cb1', slot: "price" }, (_b = store.state.line_item) === null || _b === void 0 ? void 0 : _b.subtotal_display_amount)), (((_d = (_c = store.state === null || store.state === void 0 ? void 0 : store.state.line_item) === null || _c === void 0 ? void 0 : _c.fees) === null || _d === void 0 ? void 0 : _d.data) || [])
        ...
        }), !!((_e = store.state.line_item) === null || _e === void 0 ? void 0 : _e.tax_amount) && (index.h("sc-line-item", { key: 'c5bfd12d3cfa9c0cd88a1e5f834a958623952b2f' }, index.h("span", { key: 'f6ac7ff98dc630d4687f54038ae05985bca0b15c', slot: "description" }, wp.i18n.__('Tax', 'surecart')), index.h("span", { key: 'acb3731d7d6f46df32c415dd5244957f952e1ffc', slot: "price" }, (_f = store.state.line_item) === null || _f === void 0 ? void 0 : _f.tax_display_amount))), index.h("sc-divider", { key: 'e88417d1a7ac7083503296d68492937c2dd98739' }), index.h("sc-line-item", { key: '37efd900db304d6a3ce8949d279cf7ab452f0438', style: { '--price-size': 'var(--sc-font-size-x-large)' } }, index.h("span", { key: '09d18708fbc6ffeea66def85964b6c697a11f43d', slot: "title" }, wp.i18n.__('Total', 'surecart')), index.h("span", { key: '240deca3433468ad9c2182edcc4001a5aea8315c', slot: "price" }, (_g = store.state.line_item) === null || _g === void 0 ? void 0 : _g.total_display_amount)), this.renderConversion()));
    }
};
