...
const ScSubscriptionsList = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: '4e2651ae4ea331926981800eb4e134eb37377602', class: "subscriptions-list", error: this.error }, index.h("span", { key: '832a93c081497295cc2723aca0fde67b76b113ce', slot: "heading" }, index.h("slot", { key: 'f22099a108f9c99563ee3d2b8b30cac76c9ef534', name: "heading" }, this.heading || wp.i18n.__('Subscriptions', 'surecart'))), !!this.allLink && !!((_a = this.subscriptions) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: '2a6b84acf5f4a78d53f6d9fa6d18f065ba94faf1', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || 'Subscriptions') }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: 'd56c97da215bac9b3a227077366c10b9664b40f2', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (index.h("sc-pagination", { key: 'be6b4ebadef613f157292fe99865f897fed7f83a', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.subscriptions) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && index.h("sc-block-ui", { key: '93924dde82ad8fc83ffbe693f4e145b941c44b4e' })));
    }
