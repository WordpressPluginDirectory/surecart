...
const ScToggle = class {
    ...
    render() {
        return (index.h("div", { key: '9b77dcfaea37d7f6c5df2b7605e72011f150ad30', part: "base", class: {
                'details': true,
            ...
            } }, index.h("header", { key: '6ea4eb65c897597b3953cf293e3b265b677f720a', ref: el => (this.header = el), part: "header", id: "header", class: "details__header", role: "button", "aria-expanded": this.open ? 'true' : 'false', "aria-controls": "content", "aria-disabled": this.disabled ? 'true' : 'false', tabindex: this.disabled ? '-1' : '0', onClick: () => this.handleSummaryClick(), onKeyDown: e => this.handleSummaryKeyDown(e) }, this.showControl && (index.h("span", { key: 'be23209896fd35ac692a2926414e7fcbecfcea6f', part: "radio", class: "details__radio" }, index.h("svg", { key: 'dc64f00bb53f07f76d3122f37c7fc61b5b986a6b', viewBox: "0 0 16 16" }, index.h("g", { key: '24d34335860b24eb2f330fbe3ac61b533bd460be', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { key: '26042ed3524c05cda859bb23f7c9135ef85a5e77', fill: "currentColor" }, index.h("circle", { key: '2319eb04138c13ecb4b1e111b06a5c664006b50b', cx: "8", cy: "8", r: "3.42857143" })))))), index.h("div", { key: '54a7dcc2f13a50a3a0738169049b7c675257ef8b', part: "summary", class: "details__summary" }, index.h("slot", { key: '4604099deff612b4923a5ffd6091c07ffbc1e70b', name: "summary" }, this.summary)), this.showIcon && (index.h("span", { key: '86a35e9ad1e26686886d171b94bc58a2f19607da', part: "summary-icon", class: "details__summary-icon" }, index.h("slot", { key: '1048689b25baa3c8a346086338461ea304f2b20d', name: "icon" }, index.h("sc-icon", { key: '29f8ea9b8f01c7ff2511edc3c45a41164b7e97fd', name: "chevron-right" }))))), index.h("div", { key: 'c2e9838a8f24555f26fd69e04ea4004df5e6f6b8', class: "details__body", ref: el => (this.body = el), part: "body" }, index.h("div", { key: 'efeef546ddbafefa504844b067147d5572aa6602', part: "content", id: "content", class: "details__content", role: "region", "aria-labelledby": "header" }, index.h("slot", { key: 'fbaed8b55f6fe2e95ddbcaa2fdc6d2971bbc3775' })))));
    }
