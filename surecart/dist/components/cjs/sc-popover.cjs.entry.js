...
const ScPopover = class {
    ...
    render() {
        return (index.h("div", { key: '2605206c30b15b9099b01e0007c5e63301d08cdf', part: "base", class: {
                'popover': true,
                'popover--open': this.open,
                'popover--disabled': this.disabled,
            } }, index.h("span", { key: '73fe426dbd8b1e66135c0795b9ce0f2c9bf64f03', part: "trigger", class: "popover__trigger", ref: el => (this.trigger = el), onClick: () => {
                if (this.disabled)
                    return;
                if (this.open) {
                    this.hide();
            ...
            }, onKeyDown: e => this.handleTriggerKeyDown(e), tabindex: "0", role: "button", "aria-expanded": this.open ? 'true' : 'false', "aria-haspopup": "dialog", "aria-label": wp.i18n.__('Press Enter to open popover', 'surecart') }, index.h("slot", { key: '9c8de2e1eda5fb27799bac9d419a06282fa2d061', name: "trigger" })), index.h("div", { key: '264f2c477693024ad2c9f90932a2d6888757ff79', class: "popover__positioner", ref: el => (this.positioner = el) }, index.h("div", { key: '74f50003d076b898c239d709336db82ecfa5b6e1', part: "panel", class: "popover__panel", role: "dialog", "aria-modal": "false", tabindex: "-1", ref: el => (this.panel = el) }, index.h("div", { key: '88a00d57c449449d3e2b57502340429604334c47', class: "popover__header" }, index.h("slot", { key: '724e41846778acbf6bf6b0acefd9f6d708044fc1', name: "title" }), index.h("button", { key: 'b3a858c5e3c37e83b80c5aad373126e85ebd38e1', type: "button", class: "popover__header-close-button", onClick: () => this.handleHide(), onKeyDown: e => e.key === 'Enter' && this.handleHide(), "aria-label": wp.i18n.__('Close', 'surecart') }, index.h("sc-icon", { key: 'b1d0c7beb6b0e146cbde0bbabff720e7a42ffd33', class: "popover__header-close-icon", name: "x" }))), index.h("slot", { key: '8e8a5f8aea58430f5eeb03517d7cf6480c72fa92', name: "content" }), index.h("div", { key: '17ec161c3270f897d378748fd9ecfd0bbe8f0ffb', class: "popover__footer" }, index.h("slot", { key: 'be0fbe2b778c338c7605be797a6c170cf0f721f1', name: "footer" }))))));
    }
