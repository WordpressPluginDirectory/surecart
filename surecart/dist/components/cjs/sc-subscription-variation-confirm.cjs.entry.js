...
const ScSubscriptionVariationConfirm = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: '7648cdad1711adacf4b87d2574bcbb6eb08ea13d', heading: this.heading || wp.i18n.__('Enter An Amount', 'surecart'), class: "subscription-switch" }, index.h("sc-card", { key: '788dc3fd324f6b423974dd2dfe82d3003c163447' }, index.h("sc-form", { key: 'fb229b6ada9c482705bf4600970f533c77ad6282', onScSubmit: this.handleSubmit }, index.h("div", { key: 'bfeecb2e13175b5889a8311fc3af693de41f1e89', class: "sc-product-variation-choice-wrap" }, (((_b = (_a = this.product) === null || _a === void 0 ? void 0 : _a.variant_options) === null || _b === void 0 ? void 0 : _b.data) || []).map(({ name, values, id }, index$1) => {
            var _a, _b;
        ...
        })), index.h("sc-button", { key: '3cac88c35ef8566098b75d54a9b2441a639ecaf6', type: "primary", full: true, submit: true, loading: this.busy }, this.buttonText(), " ", index.h("sc-icon", { key: 'bb6457a234d5e73e3166169bbac4c2e7b67cbbda', name: "arrow-right", slot: "suffix" })))), this.busy && index.h("sc-block-ui", { key: '71b1fdc18fb7b7ef692036198d91125fc986f958', style: { zIndex: '9' } })));
    }
};
