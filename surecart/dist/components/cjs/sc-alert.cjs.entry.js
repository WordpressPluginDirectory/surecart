...
const ScAlert = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4a31f70ae17655e05d890e32c8bb81f2762694b1', style: { 'scroll-margin-top': this.scrollMargin } }, index.h("div", { key: 'e7609f695f15b5cc2e9c33815e559bd18c9e04d0', class: {
                'alert': true,
            ...
            }, part: "base", role: "alert", "aria-live": "assertive", "aria-atomic": "true", "aria-hidden": this.open ? 'false' : 'true', hidden: this.open ? false : true, onMouseMove: () => this.handleMouseMove() }, index.h("div", { key: '25e9e8f815085c3c92264e3c4e07cfee38c470a5', class: "alert__icon", part: "icon" }, index.h("slot", { key: '3ff33f25dbb4d4b39f1d69d0853a936ab8294ef3', name: "icon" }, this.icon())), index.h("div", { key: '50ddf60124ffb358b4f284673c30977852028d30', class: "alert__text", part: "text" }, index.h("div", { key: '186b5ead89ec3173fdaa7df773c7c413ae0207eb', class: "alert__title", part: "title" }, index.h("slot", { key: '9602a5a8be4bde1543d57875100348af7ff8eb64', name: "title" }, this.title)), index.h("div", { key: '214de1860ee15c8c787a99092b8d29d14487ea65', class: "alert__message", part: "message" }, index.h("slot", { key: 'a1525de20cf998fe96b5117ff8f4bde57addb538' }))), this.closable && (index.h("span", { key: '72c141d23e202b7fabf424b0c297a777005f225d', part: "close", class: "alert__close", onClick: () => this.handleCloseClick() }, index.h("span", { key: '2c2876f01a645d7adc4233117a88a9932a2e9ac3', class: "sr-only" }, "Dismiss"), index.h("svg", { key: '36097023983b4cc5e9b2048dc39dc236357e0a27', class: "h-5 w-5", "x-description": "Heroicon name: solid/x", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true" }, index.h("path", { key: '9d6f9ec00040cca726d4ea0245e90765b762cd3a', "fill-rule": "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", "clip-rule": "evenodd" })))))));
    }
