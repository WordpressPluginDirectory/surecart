...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'e36585d07a9540577a1b461ebaace55a70272fe2', class: "password" }, index.h("div", { key: '306a0e803811c3956d9134173daf18d03d2456cc' }, index.h("sc-input", { key: '287d2828ba37e64b03f3fbbcbc977899ba9dac3b', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && index.h("small", { key: '255cb177fa34a860ce70767d2eb063ed334f26c8', class: "password__hint" }, this.hintText)), this.confirmation && (index.h("div", { key: 'f6e250ecd112b542ce425beb05b74b14f7aa5348' }, index.h("sc-input", { key: 'f5a6206970d8bc5b2e758350ad4c14bc4a73ed45', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && index.h("small", { key: '29c70bafb531d34606c7db337e66fea40752035c', class: "password__hint" }, this.verifyText)))));
    }
