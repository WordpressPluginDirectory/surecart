...
const ScSubscriptionStatusBadge = class {
    ...
    render() {
        return (h("sc-tag", { key: '5fdeddcf16c7242ed989c1717a15db5e73844dc1', "aria-label": wp.i18n.sprintf(wp.i18n.__('Plan Status - %s', 'surecart'), this.getText()), type: this.getType() }, this.getText()));
    }
};
