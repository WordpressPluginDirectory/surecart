...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '3e08bd4c619c5858c0161d62abda5cd172a47ff5', hidden: this.hidden }, h("sc-form-control", { key: '8353fc1ff1688ace7f37d32738ad12712dfa7113', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, h("slot", { key: 'f264cfc7f0545a096caba329f31f0353ec265779', name: "label-end", slot: "label-end" }), h("div", { key: '07308b4d593863ee51aabc2fa2671a5ba95477ce', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, h("span", { key: '58ff242d51622b8c27bdb8412df73c7939ae0974', part: "prefix", class: "input__prefix" }, h("slot", { key: '687730d21b3508de92b25d09cfdebd351d3211b2', name: "prefix" })), h("slot", { key: 'b4d47b91e23319c41867a9a56f45d8d4306b9448' }, h("input", { key: '57a79bcaa37699a796570cde234ddabf82710ab4', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), h("span", { key: '7eb0393586ab436bd8b2e054275fc748c9dcd7fc', part: "suffix", class: "input__suffix" }, h("slot", { key: '6331599b05299a555a84e37228b61fd445c2075c', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (h("button", { key: 'e63971fc3d1d4b0b79db4523ebf7fe823d5849d8', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, h("slot", { key: '548be8b67853364c1489abdabc1ac0a1d46b4c56', name: "clear-icon" }, h("svg", { key: 'f73432216a77d1abea80fb0c726ed6105c591460', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, h("line", { key: '583cad29ddb54c8c635d5bb844999152c3c9a9db', x1: "18", y1: "6", x2: "6", y2: "18" }), h("line", { key: '832e10c722c251294fbc8a2b958333f39da83a06', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h(Fragment, { key: 'e270121fa0488eae217e62e827d4c8fd8af57632' }, h("sc-input", { key: '0000aa48f171bc2f9355a1d0b215a056a169fa42', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), h("sc-input", { key: '0aa2092d2287f9d607b90ca23d41f0e1b0fa3887', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
...
export { ScAddress as sc_address, ScCheckbox as sc_checkbox, ScPhoneInput as sc_phone_input, ScTaxIdInput as sc_tax_id_input };

//# sourceMappingURL=sc-address_4.entry.js.map