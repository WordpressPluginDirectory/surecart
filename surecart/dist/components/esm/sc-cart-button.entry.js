...
const ScCartButton = class {
    ...
    render() {
        return (h(Host, { key: '102c47ccdcd93b3114c70a8e4783cf61ed5cccf1', tabindex: 0, role: "button", "aria-label": wp.i18n.sprintf(wp.i18n.__('Open Cart Menu Icon with %d items.', 'surecart'), this.getItemsCount()), onKeyDown: e => {
                if ('Enter' === (e === null || e === void 0 ? void 0 : e.code) || 'Space' === (e === null || e === void 0 ? void 0 : e.code)) {
                    store.state.cart = { ...store.state.cart, open: !store.state.cart.open };
                    e.preventDefault();
                }
            } }, h("div", { key: '6356566198340433c61940727a9fbb32d50000b4', class: "cart__button", part: "base" }, h("div", { key: 'c5a778dbcbb8ce0cfb707136b6d54bb6a0296c41', class: "cart__content" }, (this.showEmptyCount || !!this.getItemsCount()) && (h("span", { key: 'b2530d5ad00fea8eae4f6faa16ab9361c18a544a', class: "cart__count", part: "count" }, this.getItemsCount())), h("div", { key: 'ee5e9d6f452d1ad1e57d16df2e67ff16537c0456', class: "cart__icon" }, h("slot", { key: '7a760646f2f268a335aa309bbf094ac25eef463d' }))))));
    }
