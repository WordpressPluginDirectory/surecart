...
const ScLogin = class {
    ...
    render() {
        var _a, _b;
        return (h("div", { key: 'afcb398bff0f645289907e5f243d11dc9b426acb', class: "login-form" }, h("sc-card", { key: '680a72b0133ed9bc716a6b066230d7a9877b079d' }, !!this.error && (h("sc-alert", { key: '369cf13911c02f588a1a94945a7369481c9db54c', open: true, type: "danger", closable: true, onScHide: () => (this.error = null) }, h("span", { key: 'd6b9241f4ec8fbc1a7bf035b75b2e4f5dc29fa59', slot: "title", innerHTML: (_a = this.error) === null || _a === void 0 ? void 0 : _a.message }), (((_b = this.error) === null || _b === void 0 ? void 0 : _b.additional_errors) || []).map(({ message }) => (h("div", { innerHTML: message }))))), this.renderInner()), this.loading && h("sc-block-ui", { key: 'a582df737ed80d37884b5e8eb5a80d454d880935', spinner: true, style: { 'zIndex': '9', '--sc-block-ui-opacity': '0.5' } })));
    }
