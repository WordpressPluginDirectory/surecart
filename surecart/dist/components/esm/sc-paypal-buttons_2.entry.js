...
const ScPaypalButtons = class {
    ...
    render() {
        return (h("div", { key: '423fea070c670a70ab08401b1d937ec41bf26aef', part: `base ${this.busy || (!this.loaded && 'base--busy')}`, class: { 'paypal-buttons': true, 'paypal-buttons--busy': this.busy || !this.loaded } }, (!this.loaded || this.busy) && h("sc-skeleton", { key: '37e3e8e1dab18c60a1c43a961c8c9f8a8897b127', style: { 'height': '55px', '--border-radius': '4px', 'cursor': 'wait' } }), h("div", { key: '527b3150502b341e1629c9704b7d7c05edb818b9', class: "sc-paypal-button-container", hidden: !this.loaded || this.busy }, h("div", { key: 'b136b1aa61e84cc2eac5e7ad8225f3557e192104', part: "paypal-card-button", hidden: !this.buttons.includes('card'), class: "sc-paypal-card-button", ref: el => (this.cardContainer = el) }), h("div", { key: '3be9f1442d30734e1dd188faf6007b2dedd7d8df', part: "paypal-button", hidden: !this.buttons.includes('paypal'), class: "sc-paypal-button", ref: el => (this.paypalContainer = el) }))));
    }
...
const ScSecureNotice = class {
    ...
    render() {
        return (h("div", { key: '97a9afc9b80f61f1b216f303629bc113f5979da1', class: "notice", part: "base" }, h("svg", { key: '2bd5b64b638f4632ed554e5ccf8fc87c610dd869', class: "notice__icon", part: "icon", xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 512 512", fill: "currentColor" }, h("path", { key: '2d6e251ea65eff5e41423177948aef47dbbf74be', d: "M368,192H352V112a96,96,0,1,0-192,0v80H144a64.07,64.07,0,0,0-64,64V432a64.07,64.07,0,0,0,64,64H368a64.07,64.07,0,0,0,64-64V256A64.07,64.07,0,0,0,368,192Zm-48,0H192V112a64,64,0,1,1,128,0Z" })), h("span", { key: 'ea22ac8169c752acb10d02bb2d38a63a6dc76752', class: "notice__text", part: "text" }, h("slot", { key: 'eed47dc8b54740a3ed810a4bd2ba6f4406506078', name: "prefix" }), h("slot", { key: 'fb4517b7798e3b167127cabb5d33e05798bd0aba' }), h("slot", { key: '1d93e3af96c168f805cb2db6c322fe75c1422c03', name: "suffix" }))));
    }
};
