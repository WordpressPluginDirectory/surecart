...
const ScLicensesList = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: '9325ac194d160ed0e098794e2cde86e8dd70b4fd', class: "purchase", part: "base", error: this.error }, h("span", { key: '773f8c29f9dcd2053e22add41da14cd3c110ce84', slot: "heading" }, h("slot", { key: '6b15b0cfbb3e8ae49d7313800d4d2387a26fc9d7', name: "heading" }, this.heading || wp.i18n.__('License Keys', 'surecart'))), !!this.allLink && !!((_a = this.licenses) === null || _a === void 0 ? void 0 : _a.length) && (h("sc-button", { key: '69e6d554017124ac4d25e5f7ef4b327ac12b8307', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: 'b27969050af07a385e43d01303005eebac0086be', name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (h("sc-pagination", { key: '2380867d4b15e371f30dff60090163eec743ae61', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.licenses) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() }))));
    }
