...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (h("div", { key: '65053f3ab81e206acd2bef1b9e1293ae6bf5d4e8', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, h("span", { key: '76abbcd880c1a5f5b703d001716a029bc76114d8', part: "prefix", class: "breadcrumb-item__prefix" }, h("slot", { key: '3d42186361b3aa33182645719e937042db994430', name: "prefix" })), h(Tag, { key: '88928edce649838606355b525cee0293f3d751c3', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, h("slot", { key: '6b5169a7129f2ad8575775c316e5908b8a857501' })), h("span", { key: '9f10d6f503fc0f7a78c3accb63cab5a6c27836c8', part: "suffix", class: "breadcrumb-item__suffix" }, h("slot", { key: '4b1c3976bcb4f64b3934bce939427fd2001ef3c4', name: "suffix", onSlotchange: () => this.handleSlotChange() })), h("span", { key: 'a04c250063db3c86c298b1ca2fde1de432e06321', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, h("slot", { key: '14aecfcb4d4445c80cdeda84b4e30d7a4744b596', name: "separator", onSlotchange: () => this.handleSlotChange() }, h("sc-icon", { key: 'f1117d425f7f0d03fb1df9d829654d611a79824d', name: "chevron-right" })))));
    }
