...
const ScToggle = class {
    ...
    render() {
        return (h("div", { key: 'd4f9ddde2a64687bc52549ac32a1b9e75187c0c7', part: "base", class: {
                'details': true,
            ...
            } }, h("header", { key: 'bb174e9204f51697b790238d891cf138b2befbfc', ref: el => (this.header = el), part: "header", id: "header", class: "details__header", role: "button", "aria-expanded": this.open ? 'true' : 'false', "aria-controls": "content", "aria-disabled": this.disabled ? 'true' : 'false', tabindex: this.disabled ? '-1' : '0', onClick: () => this.handleSummaryClick(), onKeyDown: e => this.handleSummaryKeyDown(e) }, this.showControl && (h("span", { key: 'fe4858bcde411ea44db86dcb1fc7792d4a85bff9', part: "radio", class: "details__radio" }, h("svg", { key: 'ae93c528298a15b4f5fd85e9aa63dcfe358785b5', viewBox: "0 0 16 16" }, h("g", { key: '9bc2524ff7ff576e73a21432bd2c8d0c78d412cf', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, h("g", { key: '69949924d198486240299b8cd93b3dff5893610d', fill: "currentColor" }, h("circle", { key: '3d9a07da614dcee38f1e29bb7896502572cf95e8', cx: "8", cy: "8", r: "3.42857143" })))))), h("div", { key: '0f3aa0a5ec19a675f8d9f455f8a75dd94e32a84c', part: "summary", class: "details__summary" }, h("slot", { key: '6de216bcceaf68a22fc5b4925331096c6d93655c', name: "summary" }, this.summary)), this.showIcon && (h("span", { key: '60bbcb262d7697d5895539d444cefeddd07d93a6', part: "summary-icon", class: "details__summary-icon" }, h("slot", { key: '7763aee83454c906a4ceb4fc8797a503da8fd5f5', name: "icon" }, h("sc-icon", { key: '185e0ddcdfeef4137755c2ae5c3e566469afdfd9', name: "chevron-right" }))))), h("div", { key: '977f3cd41a3bf15f6d88cea5f2082b49c8afa796', class: "details__body", ref: el => (this.body = el), part: "body" }, h("div", { key: 'f4dd23d8a4013865acb955d0e4d3fb9f56734dfe', part: "content", id: "content", class: "details__content", role: "region", "aria-labelledby": "header" }, h("slot", { key: 'ecc47ffda7f001f2a4826de1243e6bde4c883d74' })))));
    }
