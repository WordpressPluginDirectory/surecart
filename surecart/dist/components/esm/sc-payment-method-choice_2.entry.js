...
const ScPaymentMethodChoice = class {
    ...
    render() {
        ...
        return (h(Tag, { key: 'ffb946cb03a890adc40840cf98fc6c414fd5b37d', "show-control": true, borderless: true, open: this.isSelected(), onScShow: () => {
                state.id = this.processorId;
                state.manual = !!this.isManual;
                state.method = this.methodId;
            } }, this.hasOthers() && h("slot", { key: 'b0ae5540b68cccb1f997309562a27b783a5b89e6', name: "summary", slot: "summary" }), this.card && !this.hasOthers() ? (h("sc-card", null, h("slot", null))) : (h("slot", null))));
    }
...
const ScPaymentSelected = class {
    ...
    render() {
        return (h("div", { key: '0e8859eb524f49170c943ac28bb7e5bcad91c06b', class: "payment-selected", part: "base" }, h("slot", { key: '03b2ab929394501a697d9b175b344dafc19bab53', name: "icon" }), h("div", { key: '6f2f17359adecc0290fc665498c7183082153ad4', class: "payment-selected__label" }, this.label), h("sc-divider", { key: '9c785dd9bebbe8d49c28b4d7e82422edf9e003bd', style: { '--spacing': 'var(--sc-spacing-xx-small)' }, exportparts: "base:divider, line:divider__line" }), h("div", { key: 'f1685bd180e4cf997ef1c5e45a8e5afe63fd5ab2', part: "instructions", class: "payment-selected__instructions" }, h("svg", { key: '8f3734bb08fd3bd737a7701096e5a2c983d041b6', part: "icon", viewBox: "0 0 48 40", fill: "var(--sc-color-gray-500)", xmlns: "http://www.w3.org/2000/svg", role: "presentation" }, h("path", { key: '4cea34c081055ff1faddbe9e2b77d3635f75b780', opacity: ".6", "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M43 5a4 4 0 00-4-4H17a4 4 0 00-4 4v11a1 1 0 102 0V5a2 2 0 012-2h22a2 2 0 012 2v30a2 2 0 01-2 2H17a2 2 0 01-2-2v-9a1 1 0 10-2 0v9a4 4 0 004 4h22a4 4 0 004-4V5zM17.992 16.409L21.583 20H6a1 1 0 100 2h15.583l-3.591 3.591a1 1 0 101.415 1.416l5.3-5.3a1 1 0 000-1.414l-5.3-5.3a1 1 0 10-1.415 1.416zM17 6a1 1 0 011-1h15a1 1 0 011 1v2a1 1 0 01-1 1H18a1 1 0 01-1-1V6zm21-1a1 1 0 100 2 1 1 0 000-2z" })), h("div", { key: '3c914066173da7b60c0d1866053603c9e6168243', part: "text", class: "payment-selected__instructions-text" }, h("slot", { key: 'a0bcf40b1ba0dcefc7ee09ddacd6822365619e83' })))));
    }
};
