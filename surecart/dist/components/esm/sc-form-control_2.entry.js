...
const ScFormControl = class {
    ...
    render() {
        return (h("div", { key: '566d1be1b0ca8131046cb5e5401572775dad7f43', part: "form-control", class: {
                'form-control': true,
            ...
            } }, h("label", { key: '147f84b9a0159229c8608c4fb829adcdc3d410b1', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, h("slot", { key: '125260ef66098fd91277a01457545ac4e5735feb', name: "label" }, this.label), h("slot", { key: 'f76b4fc4f7e9cf126e973f915990b1a005ce4eb0', name: "label-end" }), !!this.required && (h("span", { key: '8b7e826c9ad69df179dc7fa50df7dc9adb08c11c', "aria-hidden": "true", class: "required" }, ' ', "*")), h("sc-visually-hidden", { key: '49ae683740e0f86cab8fb401a7a6b8ac54432bf7' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), h("div", { key: 'b7a2c71f7dab28cdd00edcfe18f69f3ac066b00a', part: "input", class: "form-control__input" }, h("slot", { key: 'ecf7c64072260050c85a41e5f0512b94a538e327' })), this.help && (h("div", { key: '03e0b9a018bc56192ae1cd31ee7fe26cfd5149df', part: "help-text", id: this.helpId, class: "form-control__help-text" }, h("slot", { key: '4b84d854605b212af90944a02c892ea373531ec6', name: "help-text" }, this.help)))));
    }
...
const ScInput = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'fdac614b2d5238b1f68532c08c432dbc7f97edec', hidden: this.hidden }, h("sc-form-control", { key: 'c4a4d77c40bf9c8659d6eab7a556f3f323058dea', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("slot", { key: '56292fcbb7bfd056ebe4bc0b862a572f8035d2d3', name: "label-end", slot: "label-end" }), h("div", { key: 'ef84be6b976d0999c8cf2ba0cbd786a1bf59a513', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, h("span", { key: '1271a7c4a6242ed177a8723f722ae84b9dfac774', part: "prefix", class: "input__prefix" }, h("slot", { key: 'e9d4006eb04c4bbb3c1ff1dce1e80b2905ff3c69', name: "prefix" })), h("slot", { key: '070332ede432ff7df1325e6598fce25000ff57da' }, h("input", { key: '580328c702b990cd6b28983589c147151c1bfa19', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: this.type === 'password' && this.isPasswordVisible ? 'text' : this.type, name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            ...
            } })), h("span", { key: '4883c0ca15231d77090f0cf43401147c2d5b40fe', part: "suffix", class: "input__suffix" }, h("slot", { key: 'dc8c6cfdbabb3e20bcd69602b0c2ec8f26496a74', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (h("button", { key: '7cc9c6ef4016b1e9bdaf32bcebaba49e1bf2dfce', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, h("slot", { key: '2a458ddf6f35fa0416ba1b02be4663b4e1a52d40', name: "clear-icon" }, h("svg", { key: 'd6fd87b986553df6099054463cdd8b83c65bf64b', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, h("line", { key: 'bca55a140e9f86ad7028217b8b28962c97238598', x1: "18", y1: "6", x2: "6", y2: "18" }), h("line", { key: 'e389a3a37fd976ad2601f0bd2b33d294338136b6', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return getElement(this); }
