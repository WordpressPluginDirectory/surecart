...
const ScToggles = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '564017e063c3b8b01fbf556113033cec6bce714d', class: { toggles: true, [`toggles--theme-${this.theme}`]: true }, part: "base", "no-padding": true }, h("slot", { key: '70529e0600f84bf29c7992300f814a5f3f640534' })));
    }
