...
const ScUpcomingInvoice = class {
    ...
    render() {
        return (h("div", { key: 'be5cb5ee95e93d22d44067e9008ad2b4bb8e3874', class: "upcoming-invoice" }, this.error && (h("sc-alert", { key: '244e57fb51c58a8b677d8534d15f712ba7f9137e', open: !!this.error, type: "danger" }, h("span", { key: 'f96737821b5d2494d9d2fee76c78488d895a8171', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h(Fragment, { key: 'd7f0221e2d6e8e30a9f6186c94bcb5f9339b32ee' }, h("sc-dashboard-module", { key: '034ac21fcedac2e60796799d237597cb0f502520', heading: wp.i18n.__('New Plan', 'surecart'), class: "plan-preview", error: this.error }, h("sc-card", { key: '83eefc5e9313285dce440bbaad655cc1f4b7b9e8' }, this.renderContent())), h("sc-dashboard-module", { key: '0483230c1e81d884da04be4e6f26a0eb9d0fb845', heading: wp.i18n.__('Summary', 'surecart'), class: "plan-summary" }, h("sc-form", { key: '17202285a9e767b10de60c2d5dcc6ce6d00f52b5', onScFormSubmit: () => this.onSubmit() }, h("sc-card", { key: 'd80ca896169c9b9444a40bde59a4ab7f2d66ca66' }, this.renderSummary()), h("sc-button", { key: 'ba26dba612deac62167983e49fc9c3061ba9bd8a', type: "primary", full: true, submit: true, loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Confirm', 'surecart')))), h("sc-text", { key: 'bc449effb745567128d906c3eb900b4c8b99880a', style: { '--text-align': 'center', '--font-size': 'var(--sc-font-size-small)', '--line-height': 'var(--sc-line-height-normal)' } }, h("slot", { key: '5c4885513c25575404cddfb1018037b72a5e08ed', name: "terms" }))), this.busy && h("sc-block-ui", { key: 'a982b507edcb5fca3bbaec21e94ceca05fc08041' })));
    }
