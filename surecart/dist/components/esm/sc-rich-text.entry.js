...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (h(Host, { key: '6cf50adcf1ee2f5ff8ac5355221c7eec30f049b2' }, h("sc-form-control", { key: '05918489f4d25ed19f9e5f012fc36d4350f158db', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: '8eac9324a1b04389567a85cade4a661f19f53cb2', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, h("div", { key: 'f5216e0fe75c14b0615db4a88de06fc3cd717375', class: "menu" }, h("sc-button", { key: '49fccdba22e9f6908600fae7e82c7e5b27bde472', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, h("sc-icon", { key: '11d35cae4a70c69388cdef3e9a21a66ef127cb4e', name: "bold" })), h("sc-button", { key: '9f0bed9a8df7db4956d464943917c219b4e1a52e', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, h("sc-icon", { key: 'd6a676467750a4942d419e9c78d9a29c66295369', name: "italic" })), h("sc-button", { key: '1b8d69f01c9715045167d3abc7b6cc1f0113e00c', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, h("sc-icon", { key: '4dc4f8c0ed655066afb2fbc66fe104e323a45c44', name: "list" })), h("sc-button", { key: 'ccccbece64a1cc43a5abef5f085b37b4b4c35080', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, h("sc-icon", { key: '73ef417b369c8ffc8c526a5e18b187b50798c2b3', name: "minus" })), h("sc-button", { key: 'edf41ea36986d3c0324f5723ccba6f2af2f752d4', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, h("sc-icon", { key: 'fb03dc0a366a59223549d4c9f867992aa4a4ffe4', name: "corner-up-left" })), h("sc-button", { key: '08aa0888f9e00158cc4b8f67577b4d7f34628688', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, h("sc-icon", { key: 'f0224532a459f027f906694af91b883bd4d860a4', name: "corner-up-right" }))), h("div", { key: 'a5ee3af897657fbf3dd7a31b9350cad3d3d7ad26', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && h("div", { key: '1cdbbb12272063ddb72d616251ab1d6a6a6dd770', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
