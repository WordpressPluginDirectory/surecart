...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (h(Host, { key: 'bc6ef3e9d21ff75a848fb9894ed1988c56770780' }, h("sc-form-control", { key: 'ea90eb2fbc073143773dac8daef0cabd02860b54', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: '5c5251d56b0ada099b5ae98a577627791a7462c0', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, h("div", { key: 'ad3209030dd883ba59ed84ef940bf1e142af2746', class: "menu" }, h("sc-button", { key: '8f31fb19f015a561e4a0ded56932ad7107885358', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, h("sc-icon", { key: '5ec31f29af5898abfb77d6610c19d5e67332ec30', name: "bold" })), h("sc-button", { key: 'bcf9f7c1b970b11d171132f594981bd4c9ad2b03', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, h("sc-icon", { key: '81424ceb3867d73cdeefd3d9f4bdd8ad0545f3ab', name: "italic" })), h("sc-button", { key: '3c0fb04b73913679dda413bda66e58d9165941f8', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, h("sc-icon", { key: '9f60068d580c5b53ffc710d8a8ee86d7346a0f39', name: "list" })), h("sc-button", { key: 'a9b699a48707111a68140872e06833a03b9bec0f', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, h("sc-icon", { key: 'cdd8c0306298a174617058fde1b2da690a230a36', name: "minus" })), h("sc-button", { key: '6c10660acafb5909dbdaba7f60c9d1e53755cfc2', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, h("sc-icon", { key: '93ad710a4b2142ca11a9ec557030cb2a997ba03f', name: "corner-up-left" })), h("sc-button", { key: '8a9a9fd5319bc1e17565e5a319037f0d4cad182d', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, h("sc-icon", { key: '8ccc8976050513b75cb4766bf805942bc47e5fd9', name: "corner-up-right" }))), h("div", { key: '2fa059b100a4f45b2193d77d0c9c8b13d50ac04e', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && h("div", { key: 'c479b8a4f87520e753d27429786210114d41f05a', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
