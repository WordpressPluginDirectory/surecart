...
const ScUpsellSubmitButton = class {
    ...
    render() {
        return (h(Host, { key: '591ddc187b3dd1d2f6c420f0e3ecdcb24a0a47a2', class: {
                'is-busy': isBusy(),
            ...
            }, onClick: e => this.handleAddToOrderClick(e) }, h("slot", { key: '9b4c0e84b1f91e1ed6e590ca5a592813869d17e4' })));
    }
